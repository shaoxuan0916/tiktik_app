...
const Detail = ({ postDetails }: IDetailProps) => {
  ...
  return (
    <div className="flex w-full absolute left-0 top-0 bg-white flex-wrap lg:flex-nowrap">
      <div className="relative flex-2 w-1000px lg:w-9/12 flex justify-center items-start bg-black">
        <div
          className="absolute top-6 left-2 lg:left-6 flex gap-6 z-50"
          onClick={() => router.push("/")}
        >
        ...
        <div className="absolute botoom-5 lg:bottom-10 right:5 lg:right-10 cursor-pointer">
          {muted ? (
            ...
            <button onClick={() => setMuted(true)}>
              <HiVolumeUp className="text-white bg-black/20 rounded-full p-[2px] text-2xl lg:text-4xl" />
            </button>
          )}
        </div>
      </div>
